...
# MEL_FEATURE_DIR = 'Feature_log_mel/Dataset_hop_320_generalisation_study_npy'
MEL_FEATURE_DIR = 'Feature_log_mel/Dataset_hop_160_generalisation_study_npy'
...
# LOUDNESS_FEATURE_DIR = r'C:\Users\pepij\OneDrive - Delft University of Technology\SoundSCaper\Feature_loudness_ISO532_1\Dataset_wav_loudness_generalisation_study'

splits = ['training', 'validation', 'test']   
for split in splits:
    split_dir = os.path.join(DATASET_DIR)
    audio_id_path = os.path.join(split_dir, f"{split}groupids_generalisation_study.txt")
    ...
    # loud_out = os.path.join(split_dir, f"{split}_loudness_generalisation_study.pickle")
