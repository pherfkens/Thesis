...
# 
    ...
    # Add this after your model loading and before your current inference
    # from inference_timing import measure_single_sample_inference, print_timing_stats, warm_up_model

    # Warm up and measure timing
    # warm_up_model(model, generator, cuda=config.cuda)
    # timing_stats = measure_single_sample_inference(model, generator, cuda=config.cuda, num_samples=100)
