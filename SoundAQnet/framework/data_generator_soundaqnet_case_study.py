...
class DataGenerator_Mel_loudness_graph(object):
    def __init__(self, Dataset_path, node_emb_dim, number_of_nodes = 8, seed=42, normalization=True, overwrite=False):
        ...
        self.test_random_state = np.random.RandomState(10)
    ...
    def generate_testing(self, data_type, max_iteration=None):
        ...
        all_feature_file_path = os.path.join(self.Dataset_path, 'CASE_STUDY', '_hop_160_npy.pickle')
        ...
        all_feature_file_path = os.path.join(self.Dataset_path, 'CASE_STUDY', '_loudness_case_study.pickle')
        ...
        self.test_x_loudness = np.zeros((812, 15000, 1))
